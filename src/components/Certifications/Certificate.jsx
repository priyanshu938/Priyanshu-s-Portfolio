...
const Certificate = ({ certificate }) => {
  return (
    ...
    <div class="flex relative">
      <img alt="gallery" class="absolute inset-0 w-full h-full object-cover object-center" src={certificate.image} style={{ maxWidth: "100%", maxHeight: "100%" }}/>
      <div class="px-8 py-10 relative z-10 w-full border-4 border-gray-800 bg-gray-900 opacity-0 hover:opacity-100">
        <h1 class="title-font text-lg font-medium text-white mb-3">{certificate.name}</h1>
        <p class="leading-relaxed">{certificate.description}</p>
        <a
